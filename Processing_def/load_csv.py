...
# Form implementation generated from reading ui file 'load_csv.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 20, 361, 151))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Load file"))
        self.label.setText(_translate("Dialog", "File"))
        self.label_2.setText(_translate("Dialog", "Channel name"))
